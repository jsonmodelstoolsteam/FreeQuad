...
public class StageFromJava implements InitComponentV2 {

    private File file = null;
    private TableView<ObjectFile> list;

    private void openExplorer(Helper helper) {
        File selectedFile = helper.initFileOpen(new File(System.getProperty("user.home")), "Выбор .java файла", "*.java");
    ...
    public String getTitle() {
        return "Создание моделей из .java";
    }
